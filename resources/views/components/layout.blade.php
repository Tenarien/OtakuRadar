...
<header id="header" class="flex items-center justify-between px-4 py-4 bg-white border-b min-h-[70px] fixed top-0 inset-x-0 z-50">
    ...
    <!-- Mobile Navigation -->
        <nav id="collapseMenu" class="hidden card fixed inset-y-0 left-0 bg-black z-50 w-1/2 p-6 lg:hidden overflow-auto bg-opacity-70">
            ...
            <a href="{{ route('mangas.index') }}" class="w-36">
                <img src="{{ asset('svg/logo.svg') }}" alt="logo" class="mb-4">
            </a>
            <ul class="space-y-6">
                <li class="border-b">
    ...
    <nav class="hidden lg:flex lg:items-center lg:gap-5 lg:ml-auto">
        <a href="{{ route('mangas.index') }}" class="text-gray-500 hover:text-blue-500">Home</a>
        <a href="{{ route('users.bookmark') }}" class="text-gray-500 hover:text-blue-500">Bookmarks</a>
        <a href="javascript:void(0)" class="text-gray-500 hover:text-blue-500">Manga</a>
        <a href="javascript:void(0)" class="text-gray-500 hover:text-blue-500">Anime</a>
        <a href="#" class="text-gray-500 hover:text-blue-500">Surprise me</a>
    </nav>
    ...
    <div class="flex gap-4">
        ...
        <button id="mobileSearchButton" class="lg:hidden flex items-center p-2 bg-gray-100 rounded">
